...
## Objetivo
Analisar o perfil dos candidatos do ENEM 2016 da região Sudeste e aqueles nessas condições que obteriam aprovação para curso de Pedagogia de UFF no primeiro período de 2017.
...
### Situação de Trabalho Remunerado x Número de Pessoas na Casa x Escolaridade da Mãe
```{r fig.align='center', echo=FALSE, message=FALSE, warning=FALSE, fig.width = 14}
...
### Situação de Trabalho Remunerado x Idade
```{r fig.align='center', echo=FALSE, message=FALSE, warning=FALSE, fig.width = 14}
# Boxplot por TRAB
