...
## Objetivo
Analisar o perfil dos candidatos do ENEM 2016 da região Sudeste tendo critério de aprovação para curso de Pedagogia de UFF no primeiro período de 2017 e a população nessa região de interesse que prestaram o ENEM nesse ano.

## O Conjunto de Dados

O conjunto originalmente tem quase 9 milhões de observações e mais de 100 variáveis.

Após os tratamentos, a base ficou com 1.627.945 observações e 32 variáveis.
...
g1 <- base |> 
  ...
  labs(x='Escolaridade da mãe',
       ...
       title='Média de pessoas na casa segundo a escolaridade da mãe dentre os aprovados')
...
g2 <- base |> 
  ...
  labs(x='Escolaridade da mãe',
       y='Média de pessoas na casa',
       title='Média de pessoas na casa segundo a escolaridade da mãe na população geral')
